...
import KanbanSolicitacoesVoluntario from "@/components/kanban-solicitacoes-voluntario"
...
export default async function SolicitacoesVoluntarioPage() {
      ...
      <div className="flex min-h-screen bg-black text-white overflow-x-hidden">
        ...
        <DashboardLayoutWrapper>
          <Suspense fallback={<LoadingState />}>
            <KanbanSolicitacoesVoluntario userId={user.id} />
          </Suspense>
        </DashboardLayoutWrapper>
      </div>
    </SidebarProvider>
